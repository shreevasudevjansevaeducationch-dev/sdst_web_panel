...
<div class="letterhead">
    <div class="lh-center">
        ${topTitles ? `<div class="lh-top-titles">${topTitles}</div>` : ''}
        <div class="lh-org-name">${trustData.name || ''}</div>
        <div class="lh-address">${trustData.address || ''}</div>
        <div class="lh-contact-row">
            ${trustData.contact ? `
                <div class="lh-contact-item">
                    <span class="label">📞 Phone:</span> ${trustData.contact}
                </div>
            ` : ''}
            ${trustData.contactPerson ? `
                <div class="lh-contact-item">
                    <span class="label">👤 President:</span> ${trustData.contactPerson}
                </div>
            ` : ''}
            ${trustData.regNo ? `
                <div class="lh-contact-item">
                    <span class="label">📜 Reg. No:</span> ${trustData.regNo}
                </div>
            ` : ''}
        </div>
        ${trustData.cityState ? `<div class="lh-reg">${trustData.cityState}</div>` : ''}
    </div>
</div>
